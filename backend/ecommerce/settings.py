...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "django.core.context_processors.frontend",
...
#MEDIA_ROOT = '/Users/jmitch/Desktop/backend/static/media/'

STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "frontend", "static_root")

STATICFILES_DIRS = (
    os.path.join(os.path.dirname(BASE_DIR), "frontend", "static_files"),
)
